...
const InputInvestment = ({name, info, handler, action }) => {
  return (
    <div>
        <h3>{name}</h3>
        {
            ...
            <>
                ...
                <div className="input-section-education-rows">
                        <div className="input-section-education-row">
                            <div>
                                ...
                                <input type="date" name="from" id="education-from-input-1" onChange={(e) => handler(row.id, "start" , e.target.value)}/>
                            </div>
                            <div>
                                <label htmlFor="education-to-input-1">To</label>
                                <input type="date" id="education-to-input-1" onChange={(e) => handler(row.id, "end" , e.target.value)}/>
                            </div>
                            <div className="input-group">
                                <input type="text" name="where" id="education-where-input-1" className="custom-input" placeholder="Where" onChange={(e) => handler(row.id, "where" , e.target.value)}/>
                ...
                <div className="plus-minus">
                    ...
                    <div className="remove-row-btn" id="remove-education-row-btn">
                    -
                    </div> 
                </div>
                </div>
